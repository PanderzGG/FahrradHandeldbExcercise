...
{
    public class Lichtanlage : Fahrrad
    {
        ...
        public Lichtanlage(int lichtanlageID, string marke, string modell, decimal preis, int aufLager, int leuchtstaerke, string stromversorgung, string montagemoaglichkeit) : base(marke, modell, preis, aufLager)
        {
