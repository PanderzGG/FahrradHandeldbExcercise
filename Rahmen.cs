...
namespace FahrradHandel
{
    public class Rahmen : Fahrrad
    {
        ...
        public Rahmen(int rahmenID, string marke, string modell, decimal preis, int aufLager, string material, string groesse, string farbe) : base(marke, modell, preis, aufLager)
        {
